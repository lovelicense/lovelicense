...
import com.google.gwt.homepage.lovelicense.client.presenter.MyInfoPresenter;
import com.google.gwt.homepage.lovelicense.client.presenter.SajuViewPresenter;
 ...
 * edit it.
 */
public class SajuViewActivity extends AbstractActivity {
   ...
   */
  public SajuViewActivity(ClientFactory clientFactory) {
...
System.out.println("SajuViewActivity");
	  presenter = new SajuViewPresenter(clientFactory);
