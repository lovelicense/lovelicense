 ...
 */
public class TaskSearchFriendPlace extends Place {
  ...
  public static class Tokenizer implements PlaceTokenizer<TaskSearchFriendPlace> {

    public TaskSearchFriendPlace getPlace(String token) {
      return new TaskSearchFriendPlace();
    }

    public String getToken(TaskSearchFriendPlace place) {
      return "";
    }
  }
