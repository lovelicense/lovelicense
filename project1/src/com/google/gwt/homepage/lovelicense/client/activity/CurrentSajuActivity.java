 ...
 * edit it.
 */
public class CurrentSajuActivity extends AbstractActivity {
   ...
   */
  public CurrentSajuActivity(ClientFactory clientFactory) {
  ...
  public void start(final AcceptsOneWidget container, com.google.gwt.event.shared.EventBus eventBus) {
	  ...
	  presenter = new CurrentSajuPresenter(clientFactory);
