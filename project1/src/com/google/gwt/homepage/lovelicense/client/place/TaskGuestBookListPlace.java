 ...
 */
public class TaskGuestBookListPlace extends Place {

  /**
   * The tokenizer for this place. TaskList doesn't have any state, so we don't
   * have anything to encode.
   */
  @Prefix("GuestBookList")
  public static class Tokenizer implements PlaceTokenizer<TaskGuestBookListPlace> {

    public TaskGuestBookListPlace getPlace(String token) {
      return new TaskGuestBookListPlace(true);
    }

    public String getToken(TaskGuestBookListPlace place) {
      return "";
    }
  }
   ...
   */
  public TaskGuestBookListPlace(boolean taskListStale) {
