 ...
 * Edits People.
 */
public class GuestBookWriteEditor extends Composite implements Editor<GuestBookTableProxy> {
  interface Binder extends UiBinder<Widget, GuestBookWriteEditor> {
  }
