...
import com.google.gwt.homepage.lovelicense.client.presenter.GuestBookWritePresenter;
 ...
 * edit it.
 */
public class GuestBookWriteActivity extends AbstractActivity {
 ...
 // private final TaskGuestBookViewEditPlace place;
   ...
   */
  public GuestBookWriteActivity(ClientFactory clientFactory) {
   // this.place = place;
  ...
  public void start(final AcceptsOneWidget container, com.google.gwt.event.shared.EventBus eventBus) {
   //this.childEventBus = new ResettableEventBus(eventBus);
    ...
    //
	  presenter = new GuestBookWritePresenter(clientFactory);
