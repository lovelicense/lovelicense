 ...
 */
public class TaskCurrentSajuPlace extends Place {
  ...
  public static class Tokenizer implements PlaceTokenizer<TaskCurrentSajuPlace> {

    public TaskCurrentSajuPlace getPlace(String token) {
      return new TaskCurrentSajuPlace();
    }

    public String getToken(TaskCurrentSajuPlace place) {
      return "";
    }
  }
