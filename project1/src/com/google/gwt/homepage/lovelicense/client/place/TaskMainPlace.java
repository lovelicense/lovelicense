 ...
 */
public class TaskMainPlace extends Place {
  ...
  public static class Tokenizer implements PlaceTokenizer<TaskMainPlace> {

    public TaskMainPlace getPlace(String token) {
      return new TaskMainPlace();
    }

    public String getToken(TaskMainPlace place) {
      return "";
    }
  }
